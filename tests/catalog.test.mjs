...
test('every card has valid embedded art coordinates',()=>assert.ok(cards.every(c=>c.art?.atlas==='assets/card-art-atlas.avif'&&c.art.row>=0&&c.art.row<54&&c.art.col>=0&&c.art.col<21)));
